...
- **Smart protection.** Cross-source title variants of any job already in your pipeline (Starred, Applied, Interviewing, Offer, Archived) are filtered out before scoring — *"Senior Product Designer"* and *"Senior Product Designer, parental leave cover"* at the same company in the same city don't both show up.
